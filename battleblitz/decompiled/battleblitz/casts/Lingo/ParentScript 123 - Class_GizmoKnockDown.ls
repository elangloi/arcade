...
on new me, obj
  ...
  me.setImmobile(0)
  vis = [g.assets.GIZMO.GIZMO_HIT_01, g.assets.GIZMO.GIZMO_FALL_01, g.assets.GIZMO.GIZMO_FALL_02]
  att = [g.MEMBER_0, g.MEMBER_0, g.MEMBER_0]
  def = [g.assets.GIZMO.GIZMO_HIT_01D, g.assets.GIZMO.GIZMO_FALL_01D, g.assets.GIZMO.GIZMO_FALL_02D]
