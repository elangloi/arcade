...
on new me, owner
  ...
  me.setImmobile(0)
  vis = [g.assets.MAMMOTH.MAMMOTH_GROUNDPUNCH_01, g.assets.MAMMOTH.MAMMOTH_GROUNDPUNCH_02, g.assets.MAMMOTH.MAMMOTH_GROUNDPUNCH_03, g.assets.MAMMOTH.MAMMOTH_GROUNDPUNCH_04]
  att = [g.MEMBER_0, g.MEMBER_0, g.MEMBER_0, g.MEMBER_0]
  def = [g.assets.MAMMOTH.MAMMOTH_GROUNDPUNCH_01D, g.assets.MAMMOTH.MAMMOTH_GROUNDPUNCH_02D, g.assets.MAMMOTH.MAMMOTH_GROUNDPUNCH_03D, g.assets.MAMMOTH.MAMMOTH_GROUNDPUNCH_04D]
  ...
  if not me.moveDone then
    case moveState of
      ...
      STATE_WIND_UP_2:
        if initState then
          initState = 0
          g.main.screen.addEffect(new(g.classes.Class_WhiteBurstReverseEffect, me.owner, me.owner.pos + point(-19.0 * me.owner.dir, -188.0), point(0, 0), me.owner.dir))
      ...
      STATE_ATTACK:
        if initState then
          ...
          me.animation.advance()
          delayFrames = 10
          projectile = new(g.classes.Class_MammothWaveProjectile, me.owner, me.owner.pos + point(100 * me.owner.dir, 0), point(0, 0), me.owner.dir)
