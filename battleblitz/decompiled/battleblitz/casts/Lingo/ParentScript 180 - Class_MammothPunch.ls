...
on new me, obj
  ...
  me.attackDamage = g.DAMAGE_MAMMOTH_PUNCH
  me.setAttack(1)
  ...
  me.setImmobile(0)
  vis = [g.assets.MAMMOTH.MAMMOTH_PUNCH_01, g.assets.MAMMOTH.MAMMOTH_PUNCH_02, g.assets.MAMMOTH.MAMMOTH_PUNCH_03, g.assets.MAMMOTH.MAMMOTH_PUNCH_04]
  att = [g.MEMBER_0, g.assets.MAMMOTH.MAMMOTH_PUNCH_02A, g.MEMBER_0, g.MEMBER_0]
  def = [g.assets.MAMMOTH.MAMMOTH_PUNCH_01, g.assets.MAMMOTH.MAMMOTH_PUNCH_02, g.assets.MAMMOTH.MAMMOTH_PUNCH_03, g.assets.MAMMOTH.MAMMOTH_PUNCH_04]
  order = [1, 1, 2, 2, 2, 2, 2, 3, 3, 4, 4]
...
on opponentHit me
  ...
  if me.owner.opponent.isBlocking() or not me.owner.opponent.getMove().isVulnerable() then
    ...
    g.main.screen.addEffect(new(g.classes.Class_HitStarBurstEffect, me.owner, me.owner.pos + point(138.0 * me.owner.dir, -110.0), point(0, 0), me.owner.dir))
