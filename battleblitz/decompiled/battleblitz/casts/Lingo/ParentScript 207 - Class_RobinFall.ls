...
on new me, obj
  ...
  me.setImmobile(0)
  me.setMelee(0)
  vis = [g.assets.ROBIN.ROBIN_JUMP_03, g.assets.ROBIN.ROBIN_JUMP_04, g.assets.ROBIN.ROBIN_JUMP_05]
  att = [g.MEMBER_0, g.MEMBER_0, g.MEMBER_0]
  def = [g.assets.ROBIN.ROBIN_JUMP_03D, g.assets.ROBIN.ROBIN_JUMP_04D, g.assets.ROBIN.ROBIN_JUMP_05D]
