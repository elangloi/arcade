...
on new me, obj
  ...
  me.attackDamage = g.DAMAGE_ROBIN_KICK
  me.setAttack(1)
  ...
  me.setImmobile(0)
  me.setMelee(1)
  vis = [g.assets.ROBIN.ROBIN_JUMP_01, g.assets.ROBIN.ROBIN_KICK_01, g.assets.ROBIN.ROBIN_KICK_02, g.assets.ROBIN.ROBIN_KICK_03, g.assets.ROBIN.ROBIN_KICK_04, g.assets.ROBIN.ROBIN_JUMP_04, g.assets.ROBIN.ROBIN_JUMP_05]
  att = [g.MEMBER_0, g.MEMBER_0, g.MEMBER_0, g.assets.ROBIN.ROBIN_KICK_03A, g.MEMBER_0, g.MEMBER_0, g.MEMBER_0]
  def = [g.assets.ROBIN.ROBIN_JUMP_01D, g.assets.ROBIN.ROBIN_KICK_01D, g.assets.ROBIN.ROBIN_KICK_02D, g.assets.ROBIN.ROBIN_KICK_03D, g.assets.ROBIN.ROBIN_KICK_04D, g.assets.ROBIN.ROBIN_JUMP_04D, g.assets.ROBIN.ROBIN_JUMP_05D]
