...
on new me, obj
  ...
  me.setImmobile(0)
  me.setMelee(0)
  vis = [g.assets.ROBIN.ROBIN_HIT_01, g.assets.ROBIN.ROBIN_FALL_01, g.assets.ROBIN.ROBIN_FALL_02, g.assets.ROBIN.ROBIN_STANDUP_01]
  att = [g.MEMBER_0, g.MEMBER_0, g.MEMBER_0, g.MEMBER_0]
  def = [g.assets.ROBIN.ROBIN_HIT_01D, g.assets.ROBIN.ROBIN_FALL_01D, g.assets.ROBIN.ROBIN_FALL_02D, g.assets.ROBIN.ROBIN_STANDUP_01D]
