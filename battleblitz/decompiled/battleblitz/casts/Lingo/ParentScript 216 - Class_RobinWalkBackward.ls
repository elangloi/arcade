...
on new me, obj
  ...
  me.setImmobile(0)
  me.setMelee(0)
  vis = [g.assets.ROBIN.ROBIN_WALK_01, g.assets.ROBIN.ROBIN_WALK_02, g.assets.ROBIN.ROBIN_WALK_03, g.assets.ROBIN.ROBIN_WALK_04, g.assets.ROBIN.ROBIN_WALK_05, g.assets.ROBIN.ROBIN_WALK_06]
  att = [g.MEMBER_0, g.MEMBER_0, g.MEMBER_0, g.MEMBER_0, g.MEMBER_0, g.MEMBER_0]
  def = [g.assets.ROBIN.ROBIN_STAND_01D, g.assets.ROBIN.ROBIN_STAND_01D, g.assets.ROBIN.ROBIN_STAND_01D, g.assets.ROBIN.ROBIN_STAND_01D, g.assets.ROBIN.ROBIN_STAND_01D, g.assets.ROBIN.ROBIN_STAND_01D]
