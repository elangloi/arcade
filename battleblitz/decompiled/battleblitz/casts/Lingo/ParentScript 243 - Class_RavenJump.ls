property ancestor, STATE_CROUCH, STATE_ASCENT, STATE_APEX, STATE_DESCENT, STATE_LAND, STATE_GETUP, moveState, initState, delayFrames, jumpDir
global g
...
on new me, obj
  ...
  me.setImmobile(0)
  me.setMelee(0)
  vis = [g.assets.RAVEN.RAVEN_DUCK_01, g.assets.RAVEN.RAVEN_JUMP_01, g.assets.CHAR_SHARED.RAVEN_SPECIAL_03, g.assets.RAVEN.RAVEN_JUMP_02, g.assets.RAVEN.RAVEN_JUMP_03, g.assets.RAVEN.RAVEN_JUMP_04]
  att = [g.MEMBER_0, g.MEMBER_0, g.MEMBER_0, g.MEMBER_0, g.MEMBER_0, g.MEMBER_0]
  def = [g.assets.RAVEN.RAVEN_DUCK_01D, g.assets.RAVEN.RAVEN_JUMP_01D, g.assets.RAVEN.RAVEN_SPECIAL_03D, g.assets.RAVEN.RAVEN_JUMP_02D, g.assets.RAVEN.RAVEN_JUMP_03D, g.assets.RAVEN.RAVEN_JUMP_04D]
