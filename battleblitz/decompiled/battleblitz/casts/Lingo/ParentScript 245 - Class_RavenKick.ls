...
on new me, obj
  ...
  me.attackDamage = g.DAMAGE_RAVEN_KICK
  me.setAttack(1)
  ...
  me.setImmobile(0)
  vis = [g.assets.RAVEN.RAVEN_KICK_01, g.assets.RAVEN.RAVEN_KICK_02, g.assets.RAVEN.RAVEN_KICK_03, g.assets.RAVEN.RAVEN_KICK_04]
  att = [g.MEMBER_0, g.assets.RAVEN.RAVEN_KICK_02A, g.MEMBER_0, g.MEMBER_0]
  def = [g.assets.RAVEN.RAVEN_KICK_01D, g.assets.RAVEN.RAVEN_KICK_02D, g.assets.RAVEN.RAVEN_KICK_03D, g.assets.RAVEN.RAVEN_KICK_04D]
  order = [1, 1, 1, 2, 2, 2, 2, 2, 3, 3, 3, 4, 4, 4]
