...
on new me, obj
  ...
  me.attackDamage = g.DAMAGE_RAVEN_PUNCH
  me.setAttack(1)
  ...
  me.setImmobile(0)
  vis = [g.assets.RAVEN.RAVEN_CHOP_01, g.assets.RAVEN.RAVEN_CHOP_02, g.assets.RAVEN.RAVEN_CHOP_03]
  att = [g.MEMBER_0, g.assets.RAVEN.RAVEN_CHOP_02A, g.MEMBER_0]
  def = [g.assets.RAVEN.RAVEN_CHOP_01D, g.assets.RAVEN.RAVEN_CHOP_02D, g.assets.RAVEN.RAVEN_CHOP_03D]
