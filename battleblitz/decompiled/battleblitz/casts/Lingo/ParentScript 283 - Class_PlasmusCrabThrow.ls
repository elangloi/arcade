    ...
    case moveState of
      STATE_LAUNCH:
        ...
        case me.animation.orderIndex of
          ...
          14:
            projectile = new(g.classes.Class_PlasmusCrabProjectile, me.owner, me.owner.pos + point(-50.0, 0.0), point(35.0 * me.owner.dir, 0.0), me.owner.dir)
            g.main.screen.addProjectile(projectile)
            g.main.audioMgr.playSound(g.assets.PLASMUS.SFX_PLASMUS_CRABTHROW, 100, g.SFX_EVENT_PRIORITY_LOW)
          18:
            me.advanceState()
        end case
      STATE_WAIT:
