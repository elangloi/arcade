...
on new me, owner, initPos, initVel, initDir
  ...
  animState = 1
  stateAge = 0
  vis = [g.assets.CHAR_SHARED.ROBIN_FLYINGKICK_01, g.assets.CHAR_SHARED.ROBIN_FLYINGKICK_02]
    ...
    case animState of
      STATE_WAIT:
        if initState then
          ...
          targetPos = point(targetX, targetY) - point(66.0 * me.dir, -93.0)
      ...
      STATE_FLY:
        if initState then
          initState = 0
          me.setVel(30.0 * me.dir, -33.0)
        end if
        me.accelerate(point(0.0, 3.0))
        trails.update(me)
        if stateAge = 8 then
