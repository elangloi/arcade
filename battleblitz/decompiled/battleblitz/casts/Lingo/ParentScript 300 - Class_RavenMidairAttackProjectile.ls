...
on new me, owner, initPos, initVel, initDir
  ...
  me.attackDamage = g.DAMAGE_RAVEN_MIDAIR_ATTACK
  me.stunDuration = 10
  case g.villainID of
    g.FIGHTER_ID_JINX:
  ...
  me.attackMasks = att
  loopOffsets = [point(0.0, 70.0), point(72.0, 62.0), point(118.0, 32.0), point(128.0, -8.0), point(107.0, -42.0), point(60.0, -64.0), point(0.0, -70.0), point(-60, -64.0), point(-107.0, -42.0), point(-128.0, -8.0), point(-118.0, 32.0), point(-72.0, 62.0)]
