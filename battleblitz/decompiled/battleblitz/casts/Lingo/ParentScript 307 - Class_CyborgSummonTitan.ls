property ancestor, STATE_LEADIN, STATE_ATTACK, STATE_FINISH, moveState, initState, stateAge, summonEffect, summonedFighterID, visAnim, visAltAnim
global g
    ...
    case moveState of
      ...
      STATE_ATTACK:
        if initState then
          ...
          g.game.addEffect(new(g.classes.Class_CyborgSummonEffect, me.owner, me.owner.pos + point(120.0 * me.owner.dir, -105.0), point(0, 0), me.owner.dir))
