...
on new me, obj
  ...
  me.setImmobile(0)
  vis = [g.assets.STARFIRE.STARFIRE_HIT_01, g.assets.STARFIRE.STARFIRE_HIT_02, g.assets.STARFIRE.STARFIRE_HIT_03]
  att = [g.MEMBER_0, g.MEMBER_0, g.MEMBER_0]
  def = [g.assets.STARFIRE.STARFIRE_HIT_01D, g.assets.STARFIRE.STARFIRE_HIT_02D, g.assets.STARFIRE.STARFIRE_HIT_03D]
