...
on new me, obj
  ...
  me.setImmobile(0)
  me.setMelee(0)
  vis = [g.assets.STARFIRE.STARFIRE_FALL_01, g.assets.STARFIRE.STARFIRE_FALL_02, g.assets.STARFIRE.STARFIRE_FALL_01]
  att = [g.MEMBER_0, g.MEMBER_0, g.MEMBER_0]
  def = [g.assets.STARFIRE.STARFIRE_FALL_01D, g.assets.STARFIRE.STARFIRE_FALL_02D, g.assets.STARFIRE.STARFIRE_FALL_01D]
