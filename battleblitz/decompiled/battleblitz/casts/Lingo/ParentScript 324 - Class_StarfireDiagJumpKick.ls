property ancestor, STATE_LAUNCH, STATE_ATTACK, STATE_HIT, STATE_DESCENT, STATE_LAND, moveState, initState, delayFrames
global g

on new me, obj
  ancestor = new(g.classes.Class_Move, obj)
  me.attackDamage = g.DAMAGE_STARFIRE_DIAG_JUMP_KICK
  me.setAttack(1)
  ...
  me.setImmobile(0)
  me.setMelee(0)
  vis = [g.assets.STARFIRE.STARFIRE_FLYINGKICK_01, g.assets.STARFIRE.STARFIRE_FLYINGKICK_02, g.assets.STARFIRE.STARFIRE_FALL_01, g.assets.STARFIRE.STARFIRE_FALL_02]
  att = [g.MEMBER_0, g.assets.STARFIRE.STARFIRE_FLYINGKICK_02A, g.MEMBER_0, g.MEMBER_0]
  def = [g.assets.STARFIRE.STARFIRE_FLYINGKICK_01D, g.assets.STARFIRE.STARFIRE_FLYINGKICK_02D, g.assets.STARFIRE.STARFIRE_FALL_01D, g.assets.STARFIRE.STARFIRE_FALL_02D]
