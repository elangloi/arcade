...
on new me, obj
  ...
  me.setImmobile(0)
  me.setMelee(0)
  vis = [g.assets.BEASTBOY.BEASTBOY_HIT_01, g.assets.BEASTBOY.BEASTBOY_FALL_01, g.assets.BEASTBOY.BEASTBOY_FALL_02]
  att = [g.MEMBER_0, g.MEMBER_0, g.MEMBER_0]
  def = [g.assets.BEASTBOY.BEASTBOY_HIT_01D, g.assets.BEASTBOY.BEASTBOY_FALL_01D, g.assets.BEASTBOY.BEASTBOY_FALL_02D]
