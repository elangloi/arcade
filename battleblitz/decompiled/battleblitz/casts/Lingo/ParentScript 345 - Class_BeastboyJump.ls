...
on new me, obj
  ...
  me.setImmobile(0)
  me.setMelee(0)
  vis = [g.assets.BEASTBOY.BEASTBOY_CROUCH_01, g.assets.BEASTBOY.BEASTBOY_JUMP_01, g.assets.BEASTBOY.BEASTBOY_JUMP_02, g.assets.BEASTBOY.BEASTBOY_JUMP_03, g.assets.BEASTBOY.BEASTBOY_JUMP_04, g.assets.BEASTBOY.BEASTBOY_STANDUP_01]
  att = [g.MEMBER_0, g.MEMBER_0, g.MEMBER_0, g.MEMBER_0, g.MEMBER_0, g.MEMBER_0]
  def = [g.assets.BEASTBOY.BEASTBOY_CROUCH_01D, g.assets.BEASTBOY.BEASTBOY_JUMP_01D, g.assets.BEASTBOY.BEASTBOY_JUMP_02D, g.assets.BEASTBOY.BEASTBOY_JUMP_03D, g.assets.BEASTBOY.BEASTBOY_JUMP_04D, g.assets.BEASTBOY.BEASTBOY_STANDUP_01D]
