...
on new me, owner, initPos, initVel, initDir
  ...
  me.attackDamage = g.DAMAGE_BEASTBOY_GORILLA_SMASH
  me.stunDuration = 10
  needInit = 1
  vis = [g.MEMBER_0]
  att = [g.assets.BEASTBOY.BEASTBOY_WAVE_PROJECTILE_01A]
...
on update me
  ...
  if me.alive then
    ...
    if ((me.age - 1) mod 4) = 0 then
      g.main.screen.addEffect(new(g.classes.Class_DustJumpEffect, me.owner, me.pos + point(20.0 * me.owner.dir, 15.0), point(0.0 * me.owner.dir, 0.0), -me.owner.dir))
    end if
