    ...
    if me.targetAtSceneEdge then
      if choice < 25 then
        ...
        if choice < 50 then
          ...
          me.target.queueMove(g.MOVE_BEASTBOY_GORILLA_SMASH, 0)
        end if
      end if
    else
        ...
        if (me.opponentCurrVel.locH * me.opponentCurrDir) >= 0.0 then
          ...
          if choice < 25 then
            ...
            if choice < 50 then
              ...
              if choice < 75 then
                me.target.queueMove(g.MOVE_BEASTBOY_PTERODACTYL_SWOOP, 0)
              else
                me.target.queueMove(g.MOVE_BEASTBOY_RHINO_CHARGE, 0)
              end if
            end if
          end if
        end if
