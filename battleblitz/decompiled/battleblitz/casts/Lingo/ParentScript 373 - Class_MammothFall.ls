property ancestor, STATE_DESCENT_1, STATE_LAND, moveState, initState, delayFrames, jumpDir
global g
...
on new me, obj
  ...
  me.setImmobile(0)
  me.setMelee(0)
  vis = [g.assets.MAMMOTH.MAMMOTH_JUMP_02, g.assets.MAMMOTH.MAMMOTH_JUMP_01]
  att = [g.MEMBER_0, g.MEMBER_0]
  def = [g.assets.MAMMOTH.MAMMOTH_JUMP_02D, g.assets.MAMMOTH.MAMMOTH_JUMP_01D]
