...
on new me, owner
  ...
  me.setImmobile(0)
  vis = [g.assets.GIZMO.GIZMO_MACHINEGUN_02, g.assets.GIZMO.GIZMO_MACHINEGUN_04, g.assets.GIZMO.GIZMO_ELECTRO_PUNCH_01, g.assets.GIZMO.GIZMO_ELECTRO_PUNCH_02, g.assets.GIZMO.GIZMO_ELECTRO_PUNCH_03]
  att = [g.MEMBER_0, g.MEMBER_0, g.MEMBER_0, g.MEMBER_0, g.assets.GIZMO.GIZMO_ELECTRO_PUNCH_03A]
  def = [g.assets.GIZMO.GIZMO_STAND_01D, g.assets.GIZMO.GIZMO_STAND_01D, g.assets.GIZMO.GIZMO_STAND_01D, g.assets.GIZMO.GIZMO_STAND_01D, g.assets.GIZMO.GIZMO_STAND_01D]
  order = [1, 2, 3, 4, 5, 5, 5, 5, 5, 5, 5, 4, 3, 2, 1]
  ...
  if not me.moveDone then
    case moveState of
      STATE_LAUNCH:
        ...
        if me.animation.orderIndex = 4 then
          advanceState()
        end if
      STATE_WAIT:
        if initState then
