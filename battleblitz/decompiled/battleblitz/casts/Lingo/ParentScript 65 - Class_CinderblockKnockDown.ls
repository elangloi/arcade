property ancestor, STATE_LAUNCH, STATE_FALLING_1, STATE_FALLING_2, STATE_LAND, STATE_STANDUP, moveState, initState, delayFrames, stunDuration
global g
...
on new me, obj
  ...
  me.setImmobile(0)
  vis = [g.assets.CINDERBLOCK.CINDERBLOCK_HIT_01, g.assets.CINDERBLOCK.CINDERBLOCK_FALL_01, g.assets.CINDERBLOCK.CINDERBLOCK_FALL_02, g.assets.CINDERBLOCK.CINDERBLOCK_FALL_03, g.assets.CINDERBLOCK.CINDERBLOCK_STOMP_03]
  att = [g.MEMBER_0, g.MEMBER_0, g.MEMBER_0, g.MEMBER_0, g.MEMBER_0]
  def = [g.assets.CINDERBLOCK.CINDERBLOCK_HIT_01D, g.assets.CINDERBLOCK.CINDERBLOCK_FALL_01D, g.assets.CINDERBLOCK.CINDERBLOCK_FALL_02D, g.assets.CINDERBLOCK.CINDERBLOCK_FALL_03D, g.assets.CINDERBLOCK.CINDERBLOCK_STOMP_03D]
    ...
    case moveState of
      ...
      STATE_LAND:
        if initState then
          ...
          g.main.screen.addEffect(new(g.classes.Class_DustHugeFallEffect, me.owner, me.owner.pos, point(0, 0), me.owner.dir))
