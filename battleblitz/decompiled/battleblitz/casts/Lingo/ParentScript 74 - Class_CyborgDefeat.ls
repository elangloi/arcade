property ancestor, STATE_LAUNCH, STATE_FALLING, STATE_LAND, moveState, initState, delayFrames, stunDuration, visAnim, visAltAnim
global g
...
on new me, obj
  ...
  me.setImmobile(0)
  me.setMelee(0)
  vis = [g.assets.CYBORG.CYBORG_HIT_01, g.assets.CYBORG.CYBORG_HIT_02, g.assets.CYBORG.CYBORG_HIT_03]
  visAlt = [g.assets.CYBORG.CYBORG_HIT_ALT_01, g.assets.CYBORG.CYBORG_HIT_ALT_02, g.assets.CYBORG.CYBORG_HIT_ALT_03]
  att = [g.MEMBER_0, g.MEMBER_0, g.MEMBER_0]
  def = [g.assets.CYBORG.CYBORG_HIT_01D, g.assets.CYBORG.CYBORG_HIT_02D, g.assets.CYBORG.CYBORG_HIT_03D]
