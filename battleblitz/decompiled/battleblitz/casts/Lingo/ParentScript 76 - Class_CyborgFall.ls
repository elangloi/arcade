property ancestor, STATE_DESCENT_1, STATE_DESCENT_2, STATE_LAND, moveState, initState, delayFrames, jumpDir, visAnim, visAltAnim
global g
...
on new me, obj
  ...
  me.setImmobile(0)
  me.setMelee(0)
  vis = [g.assets.CYBORG.CYBORG_JUMP_02, g.assets.CYBORG.CYBORG_JUMP_01, g.assets.CYBORG.CYBORG_CROUCH_01]
  visAlt = [g.assets.CYBORG.CYBORG_JUMP_ALT_02, g.assets.CYBORG.CYBORG_JUMP_ALT_01, g.assets.CYBORG.CYBORG_CROUCH_ALT_01]
  att = [g.MEMBER_0, g.MEMBER_0, g.MEMBER_0]
  def = [g.assets.CYBORG.CYBORG_JUMP_02D, g.assets.CYBORG.CYBORG_JUMP_01D, g.assets.CYBORG.CYBORG_CROUCH_01D]
