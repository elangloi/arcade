property ancestor, STATE_CROUCH, STATE_ASCENT, STATE_APEX, STATE_DESCENT, STATE_LAND, moveState, initState, delayFrames, jumpDir, visAnim, visAltAnim
global g
...
on new me, obj
  ...
  def = [g.assets.CYBORG.CYBORG_CROUCH_01D, g.assets.CYBORG.CYBORG_JUMP_01D, g.assets.CYBORG.CYBORG_JUMP_02D]
  order = [1, 2, 3, 1]
