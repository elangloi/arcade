"""Decompile every piece of ActionScript in the SWF -> <game>/decompiled/code/*.txt

uv run python dump_code.py --game ../../<game>
"""
from pathlib import Path
import swfraw, avm1
from common import DECOMPILED
OUT = DECOMPILED / 'code'; OUT.mkdir(parents=True, exist_ok=True)
...
def walk(tags, ctx, lines, frame_start=1):
    ...
    for code, name, tb in tags:
        if name == 'ShowFrame': frame += 1
            ...
            po = swfraw.place_object2(tb, v3=(name == 'PlaceObject3'))
