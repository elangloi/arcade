...
def place_object2(body, swf_version=6):
    """PlaceObject2 -> dict with depth, id, matrix, name, ratio, clip actions [(event_flags, bytes)]"""
    r = Reader(body); flags = r.u8(); depth = r.u16()
